...
robot platforms: the Alphabot and the Deltabot.  It also contains links to raw data, relevant curated datasets and analysis scripts for reproducing the results. 
